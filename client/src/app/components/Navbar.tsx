            ...
            >
              ...
              <AnimatePresence>
                {loginDropdownOpen && (
                  ...
                  >
                    <Link to="/login?role=student" className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#00a992]/10 transition cursor-pointer group/item">
                    ...
                    <Link to="/login?role=teacher" className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#00a992]/10 transition cursor-pointer group/item">
                      <span className="w-2 h-2 bg-[#00a992] rounded-full group-hover/item:scale-125 transition duration-300"></span>
                      <span className="text-sm font-medium text-gray-700 group-hover/item:text-[#063831] transition">
                        Login as Teacher
                      </span>
          ...
          >
            ...
            <div className="pt-2">
              ...
              <div className="mt-2 space-y-1 pl-3">
                <Link to="/login?role=student" className="flex items-center gap-2.5 py-2.5 hover:text-[#00a992] transition text-gray-300">
                  <span className="w-1.5 h-1.5 bg-[#00a992] rounded-full"></span>
                  <span className="text-sm font-medium">As Student</span>
                </Link>
                <Link to="/login?role=teacher" className="flex items-center gap-2.5 py-2.5 hover:text-[#00a992] transition text-gray-300">
                  <span className="w-1.5 h-1.5 bg-[#00a992] rounded-full"></span>
